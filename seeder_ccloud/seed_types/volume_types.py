...
class Volume_Types(BaseRegisteredSeedTypeClass):
    ...
    @staticmethod
    @kopf.on.update('kopfexamples', annotations={'operatorVersion': 'version2'}, field='spec.volume_types')
    @kopf.on.create('kopfexamples', annotations={'operatorVersion': 'version2'}, field='spec.volume_types')
