...
class Rbac_Policies(BaseRegisteredSeedTypeClass):
    ...
    @staticmethod
    @kopf.on.update('kopfexamples', annotations={'operatorVersion': OPERATOR_ANNOTATION}, field='spec.rbac_policies')
    @kopf.on.create('kopfexamples', annotations={'operatorVersion': OPERATOR_ANNOTATION}, field='spec.rbac_policies')
